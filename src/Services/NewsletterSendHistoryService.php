...
final class NewsletterSendHistoryService
{
    use HasCacheKeyGeneration;

    private const CACHE_TAG = 'newsletter-send-history';
    ...
    {
        $query = NewsletterSendHistory::query();
    ...
    {
        $cacheKey = $this->generateCacheKey('newsletter_send_history', 'count', $newsletter ? [$newsletter->id] : ['global']);
