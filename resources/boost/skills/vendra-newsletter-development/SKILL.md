...
Treat `app-modules/vendra-newsletter` as the source of newsletter domain behavior and Filament admin UI.
...
- Run module checks from the package when possible: `composer --working-dir=app-modules/vendra-newsletter test` and `composer --working-dir=app-modules/vendra-newsletter analyse`.
